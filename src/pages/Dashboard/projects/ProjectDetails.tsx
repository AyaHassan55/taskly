...
import updateProjectService from "../../../services/projects/update-project.service.ts"

import getProjectById from "../../../services/projects/get-project-by-id.service.ts"
import ProjectPageHeader from "../../../components/ui/proiectPageHeader.tsx"
...
useEffect(() => {
  ...
  const handleUpdateProject = async (data:addProjectFormData) => {
        const token = Cookies.get("access_token");
      ...
      <div className="md:mt-10 w-full md:px-4 md:min-h-screen flex items-start justify-center">
        <div className="w-full min-h-screen md:bg-[#FFFFFF] md:shadow_[0_1px_2px_0_#0000000D] md:border md:border-transparent md:rounded-lg  md:max-w-xl flex flex-col items-start justify-start ">
          ...
          <header className="flex border-b border-[#F1F3FF] px:[32px] p-8 ">
            <div className="md:flex md:items-center md:justify-center md:gap-4">
              ...
              <div className=" flex flex-col">
                ...
                <h1 className="text-[#041B3C] font-semibold text-[24px] leading-8 ">Edit Project</h1>
          ...
          {/*---------- main form------------- */}
           ...
           <form className="w-full min-h-121.75 flex  flex-col p-8 " onSubmit={handleSubmit(handleUpdateProject)} >
            {/* project title input */}
  ...
  `}
            ...
            <div className="flex md:flex-row flex-col flex-col-reverse justify-between items-center mt-auto pt-4 gap-4 md:gap-1 ">
              <Link to={ROUTES.PROJECTS} className="md:text-[14px] text-[16px] md:font-bold font-medium md:leading-5 leading-6 md:text-[#4F5F7B] text-[#003D9B] " >Cancel</Link>
              ...
              className="flex justify-center gap-2 md:rounded-xs rounded-lg w-full md:w-auto items-center md:py-3 py-4 md:px-6
                        ...
                        bg-linear-to-br from-[#003D9B] to-[#0052CC]  cursor-pointer  disabled:opacity-50
