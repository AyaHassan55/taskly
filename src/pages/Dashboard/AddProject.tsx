...
const AddProject = ({ }: IProps) => {
  return (
    ...
    <div className="flex items-end justify-between  ">
      ...
      <button className="flex justify-center gap-2 rounded-xs items-center md:py-3 md:px-6 bg-linear-to-br from-[#003D9B] to-[#0052CC] shadow_[0px_1px_2px_0_#0000000D] cursor-pointer">
