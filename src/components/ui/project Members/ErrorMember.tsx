  ...
  return (
    <div className="min-h-screen  flex flex-col items-center justify-center gap-10.75 ">
      ...
      <div className="flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-center  text-[#434654] font-normal text-[16px] leading-6 ">We're having trouble retrieving your project members right now. Please try again in a moment.</p>
      </div>
